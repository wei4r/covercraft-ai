...
def google_search_fallback(query: str) -> PerplexitySearchOutput:
    """
    ...
    Returns:
        PerplexitySearchOutput with search results
    """
    try:
        ...
        if not api_key or not engine_id:
            return PerplexitySearchOutput(
                success=False,
                error_message="Google Custom Search API credentials not configured"
            )
...
google_search_tool = FunctionTool(google_search_fallback)